          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="relative">
                <img src="https://ext.same-assets.com/741558681/3228089916.jpeg" alt="Fabianna" className="w-full h-64 object-cover" />
                <div className="absolute top-4 right-4">
                  <span className="bg-red-500 text-white px-2 py-1 rounded text-xs font-medium">Em Atendimento</span>
                </div>
              </div>
              <div className="p-6">
                ...
                <div className="flex items-center mb-3">
                  ...
                  <span className="ml-2 text-sm text-gray-600">5.0 (1247 avaliações)</span>
                </div>
                <p className="text-gray-600 mb-4">Tarot e Cartomancia</p>
                <div className="text-center">
                  <div className="text-2xl font-bold text-green-600 mb-2">R$ 3,50/min</div>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="relative">
                <img src="https://ext.same-assets.com/741558681/540868604.png" alt="AnnaFreya" className="w-full h-64 object-cover" />
                <div className="absolute top-4 right-4">
                  <span className="bg-green-500 text-white px-2 py-1 rounded text-xs font-medium">Disponível</span>
                </div>
              </div>
              <div className="p-6">
                ...
                <div className="flex items-center mb-3">
                  ...
                  <span className="ml-2 text-sm text-gray-600">4.9 (890 avaliações)</span>
                </div>
                <p className="text-gray-600 mb-4">Runas e Numerologia</p>
                <div className="text-center">
                  <div className="text-2xl font-bold text-green-600 mb-2">R$ 4,00/min</div>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="relative">
                <img src="https://ext.same-assets.com/741558681/2547096740.jpeg" alt="Mystic Luna" className="w-full h-64 object-cover" />
                <div className="absolute top-4 right-4">
                  <span className="bg-yellow-500 text-black px-2 py-1 rounded text-xs font-medium">Ocupado</span>
                </div>
              </div>
              <div className="p-6">
                ...
                <div className="flex items-center mb-3">
                  ...
                  <span className="ml-2 text-sm text-gray-600">4.8 (650 avaliações)</span>
                </div>
                <p className="text-gray-600 mb-4">Astrologia e Cristais</p>
                <div className="text-center">
                  <div className="text-2xl font-bold text-green-600 mb-2">R$ 3,75/min</div>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="relative">
                <img src="https://ext.same-assets.com/741558681/1685023612.jpeg" alt="Sophia Vidente" className="w-full h-64 object-cover" />
                <div className="absolute top-4 right-4">
                  <span className="bg-green-500 text-white px-2 py-1 rounded text-xs font-medium">Disponível</span>
                </div>
              </div>
              <div className="p-6">
                ...
                <div className="flex items-center mb-3">
                  ...
                  <span className="ml-2 text-sm text-gray-600">4.9 (1050 avaliações)</span>
                </div>
                <p className="text-gray-600 mb-4">Vidência e Búzios</p>
                <div className="text-center">
                  <div className="text-2xl font-bold text-green-600 mb-2">R$ 4,25/min</div>
